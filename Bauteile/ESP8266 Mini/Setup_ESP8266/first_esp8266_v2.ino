/**
 * This program will pass-through serial connection to ESP. This makes it possible to send AT commands to the device.
 ...
 * 
 * http://www.electronicslovers.com/2017/11/learn-how-to-setup-wifi-module-Serial1.html
 * 
 * Code based on https://forum.arduino.cc/index.php?topic=406354.0
 * AT command reference: https://room-15.github.io/blog/2015/03/26/Serial1-at-command-reference/
 * 
 */
...
void setup() {
  Serial.begin(115200);
  delay(2000);
  Serial1.begin(9600); // your esp's baud rate might be different 9600, 57600, 76800 or 115200
  delay(2000);
...
void loop() {
  if(Serial1.available()) // check if the ESP module is sending a message 
  {
